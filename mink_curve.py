...
def count_segments(depth: int) -> int:
    ...
    The Minkowski curve follows a pattern where each recursion level 
    multiplies the number of segments by 8, resulting in exponential growth.
    ...
    return count_segments(depth - 1) * 8
