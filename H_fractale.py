...
def draw_H(x: float, y: float, width: int, height: int, step: int, total_steps: int) -> None:
    """
...
def H_recursive(x: float, y: float, width: int, height: int, depth: int, step: int, total_steps: int) -> None:
    """
    ...
    step = H_recursive(x, y + height / 2, new_width, new_height, new_depth, step, total_steps)
    step = H_recursive(x + width / 2, y + height / 2, new_width, new_height, new_depth, step, total_steps)
    step = H_recursive(x, y, new_width, new_height, new_depth, step, total_steps)
    step = H_recursive(x + width / 2, y, new_width, new_height, new_depth, step, total_steps)
